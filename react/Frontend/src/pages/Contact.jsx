...
function Contact(){
  ...
  >
    ...
    <div className="faq-content" style={{ marginBottom: 30 }}>
      ...
      >
        <center>Pilih salah satu pertanyaan yang sudah kami sediakan.</center>
      </h5>
      <div
        className="row"
        style={{
            ...
            >
                ...
                <div className="accrodion-content">
                  <div className="inner">
                    <p>
                      ...
                      menukarkan sampah kita melalui website ini, dan juga dapat
                      ditukarkan melalui menu <a href="point.html">poin</a>.
                    </p>
                  </div>
                </div>
              </div>
              <div className="accrodion">
                ...
                <div className="accrodion-content">
                  <div className="inner">
                    <p>
                      Untuk pembuatan akun dapat melalui menu registrasi yang
                      telah tersedia ataupun dapat melalui{" "}
              ...
              <div className="accrodion last-chiled">
                ...
                <div className="accrodion-content">
                  <div className="inner">
                    <p>
                      Kamu dapat mencari komunitas peduli lingkungan di sekitar
                      kamu, dan kamu dapat melakukan registrasi anggota dari
                      komunitas kamu ke website kami ini.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="contact-one__right">
          ...
          >
            <div className="row">
              ...
              <div className="col-xl-12 col-lg-6 col-md-6">
                <div className="contact-one__form-input-box">
                  <input type="text" placeholder="Nomor Ponsel" name="phone" />
                </div>
              </div>
              <div className="col-xl-12 col-lg-6 col-md-6">
                <div className="contact-one__form-input-box">
